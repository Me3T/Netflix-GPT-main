  ...
  return (
    <div className="py-4 px-0 md:px-6">
      ...
      <div className="flex relative">
        <div
          ref={elementRef}
          className="flex py-2 overflow-x-scroll overflow-y-hidden no-scrollbar scroll-smooth "
        >
          ...
          {!leftArrowDisable && (
            <button
              ...
              className="absolute h-[200px] md:h-[300px]  md:pt-0 bg-black bg-opacity-50 text-3xl  md:text-5xl z-50 sideArrow"
            >
              <b>
          ...
          {!rightArrowDisable && (
            <button
              ...
              className="absolute h-[200px] md:h-[300px]  md:pt-0 bg-black bg-opacity-50 right-0 text-3xl md:text-5xl z-50 sideArrow"
            >
              <b>
